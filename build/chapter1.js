...
/***/ (function(module, exports) {
	...
	var power = function power(base, exponent) {
	  var result = 1;
	  for (var _count = 0; _count < exponent; _count++) {
	    result = result * base;
	...
	// Drawing a mountain with function
	{
	  ...
	  var landscape = function landscape() {
	    var result = "";
	    var flat = function flat(size) {
	      for (count; count < size; count++) {
	        result = result + "_";
	      };
	    };
	    var mountain = function mountain(size) {
	      result += "/";
	...
	//Solution from Book
	{
	  var _landscape = function _landscape() {
	    var result = "";
	    var flat = function flat(size) {
	...
	{
	  var _power = function _power(base, exponent) {
	  ...
	  console.log(_power(4));
	  // → 16
	  console.log(_power(4, 3));
	  // → 64
	}
	...
	//Simple recursion
	{
	  var _power2 = function _power2(base, exponent) {
	    if (exponent == 0) return 1;else return base * _power2(base, exponent - 1);
	  };

	  console.log(_power2(2, 3));
	}
...

	{
	  ...
	  var printFarmInventory = function printFarmInventory(cows, chickens) {
	    //Cow digits counter
...

	{
	  ...
	  var zeroPad = function zeroPad(number, width) {
	  ...
	  var _printFarmInventory = function _printFarmInventory(cows, chickens, pigs) {
	    console.log(zeroPad(cows, 3) + " Cows");
	    console.log(zeroPad(chickens, 3) + " Chickens");
	    console.log(zeroPad(pigs, 3) + " Pigs");
	  };

	  _printFarmInventory(7, 16, 3);
	}
...

	{
	  var _isEven = function _isEven(n) {
	    if (n == 0) return true;else if (n == 1) return false;else if (n < 0) return _isEven(-n);else return _isEven(n - 2);
	  };
	...
	{
	  // Bean Counting
	  var countBs = function countBs(b) {
	    var a = b.toLowerCase();
